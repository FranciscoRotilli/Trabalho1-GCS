...
public class Manutencao {
    ...
    /**
     * Verifica se a manutenção está atrasada com base em seus critérios:
     * - Status deve ser 1 (em andamento)
     * - Data de retorno deve ser null
     * - Mais de 7 dias devem ter se passado desde a data do pedido
     *
     * @return true se a manutenção estiver atrasada; false caso contrário
     */
